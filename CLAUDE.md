...
1. **Hero.** Otsikko: "Vuokrasopimus, jonka molemmat allekirjoittavat mielellään." Alaotsikko: "Reilusoppari hoitaa sopimuksen, kuvat asunnon kunnosta, vuokrakuittaukset ja lopuksi todistuksen – molemmille. Ensimmäinen vuokrasuhde on ilmainen." CTA `<PrimaryCta />` ("Aloita ilmaiseksi" / odotuslista), alle "Vuokralaiselle aina maksuton."
   Heron visuaalinen elementti: **kaksipuolinen näkymä**. Kaksi samankokoista sopimuskorttia (`ContractPreview`) – vuokranantajan ja vuokralaisen näkymä samasta sopimuksesta – ja niiden alla yksi yhteinen rivi, joka sitoo ne yhdeksi asiakirjaksi. Kortit eroavat vain vastapuolesta ja hinnasta; vuokra ja alkamispäivä ovat molemmissa samat. Valittu osapuoli on aina vasemmalla. Vaihtokytkin heron yläreunassa "Olen vuokranantaja / Olen vuokralainen" vaihtaa alaotsikon ja CTA-tekstin (vuokralaiselle: "Pyydä vuokranantajaa käyttämään Reilusopparia" → valmis viestipohja jaettavaksi). Kytkimen tila muistetaan sivuston sisällä (URL-parametri, ei evästettä).
...
3. **Ainahan asunnoissa jotain on.** Tämä osio on sivun sydän ja sen teksti on sitova (Jukan kirjoittama):
   ...
   Vieressä katselmuspöytäkirja (`InspectionPreview`): tilat ja niiden kuvat riveinä – selite, kuvaajan tunnusväri ja tiivisteen alku – sekä lukitusaika. **Pöytäkirjassa ei ole piirrettyjä valokuvia**: kuva on siinä todiste, ja piirretty todiste on sisäisesti ristiriitainen (ks. DECISIONS.md 2026-09-12). Aikaleima on asiakirjassa itsessään, joten erillistä kuvatekstiä ei ole. Alle yksi asiallinen lause: "Alkukatselmus on osa sopimusta: kumpikin kuvaa ne kohdat, jotka itse pitää olennaisina, ja molemmat hyväksyvät kuvat allekirjoittaessaan vuokrasopimuksen. Muuttopäivänä katsotaan samoja kuvia." (Korjattu 2026-09-10, aiemmin "molemmat kuvaavat samat huoneet" – ks. DECISIONS.md.) Ei sanaa "riita" tämän kappaleen ulkopuolella etusivulla.
...
**Asiakirjat ovat merkkausta, eivät kuvia.** Sopimus, katselmuspöytäkirja, vuokratodistus, kuittausilmoitus ja verolaskelma esitetään sivustolla `src/components/previews/`-komponentteina, jotka näyttävät samat kentät ja saman sanaston kuin sovellus. Syy: SVG-kuvana sama sisältö olisi sumeaa pienessä koossa ja vanhentuisi hiljaa, kun tuotteen sanasto muuttuu. Kukin asiakirja on saavutettavuudelle yksi kuva (`role="img"` + `aria-label`), eikä sen sisällä ole nappeja tai linkkejä.
